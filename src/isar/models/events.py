...
class RobotServiceEvents:
    def __init__(self) -> None:
        self.mission_status_updated: Event[TaskStatus] = Event("mission_status_updated")
        ...
        self.request_inspection_upload: Event[Tuple[TASKS, Mission]] = Event("request_inspection_upload")
