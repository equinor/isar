...
from isar.state_machine.transitions.return_home import (
...
class StateMachine(object):
        ...
        self.transitions: List[dict] = [
            ...
            },
            {
                ...
                "before": [
                    ...
                    def_transition(self, trigger_start_mission_event),
                ],
            },
            {
                "trigger": "request_mission_start",
            ...
            },
            {
                ...
                "source": [self.idle_state, self.await_next_mission_state],
                "dest": self.returning_home_state,
                "prepare": def_transition(self, put_start_mission_on_queue),
                "conditions": [
                    def_transition(self, set_return_home_status),
                    def_transition(self, initialize_robot),
                ],
                "before": def_transition(self, trigger_start_mission_event),
            },
            {
                "trigger": "request_return_home_from_api",
                "source": [self.idle_state, self.await_next_mission_state],
            ...
            },
            {
                ...
                "dest": self.returning_home_state,
                "conditions": [
                    def_transition(self, start_return_home_mission),
                    def_transition(self, set_return_home_status),
                    def_transition(self, initialize_robot),
                ],
                "before": def_transition(self, trigger_start_mission_event),
    ...
    def begin(self):
        ...
        self.start_machine()  # type: ignore
