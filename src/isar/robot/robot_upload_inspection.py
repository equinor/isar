...
from robot_interface.models.exceptions.robot_exceptions import ErrorMessage, RobotException, RobotRetrieveInspectionException
...
class RobotUploadInspectionThread(Thread):
    ...
    def run(self):
        ...
        self.logger.info(f"Inspection result: {str(inspection.id)[:8]} queued for upload")
        self._is_done = True
