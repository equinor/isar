...
from robot_interface.models.mission.status import RobotStatus, TaskStatus, MissionStatus
...
class RobotInterface(metaclass=ABCMeta):
    ...
    def mission_status(self, mission_id: str) -> MissionStatus:
        """Gets the status of the currently active mission on robot.

        Returns
        -------
        MissionStatus
            Status of the execution of current mission.
