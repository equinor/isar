...
def test_read_mission_from_file(mission_reader) -> None:
    ...
    assert (
        expected_metadata.coordinate_reference_system
        == MissionMetadata.coordinate_reference_system
    )
    assert (
        expected_metadata.vertical_reference_system
        == MissionMetadata.vertical_reference_system
    )
